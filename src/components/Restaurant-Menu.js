...
const RestaurantMenu = () => {
  ...
  return (
    <div className="restaurant-menu">
      ...
      <div className="menu-data-container1">
        {itemCards1.map((category) => (
          <div className="menu-data-wrapper1" key={category?.title}>
            <div className="data1">{category?.title}</div>
            ...
            {category?.itemCards?.map((items) => {
              ...
              return (
                <div key={info?.id} className="menu-item1">
                  <div className="container-1">
                    <div className="align1">{info?.name}</div>
                    <div className="align1">₹ {info?.price / 100}</div>
                  ...
                  >
                    ...
                    ></path>
                      ...
                      <span className="align3">
                        {info?.ratings?.aggregatedRating?.rating} (
                        {info?.ratings?.aggregatedRating?.ratingCountV2})
                      </span>
                    </div>
                    <div className="align4">{info?.description}</div>
                  </div>
                  <div className="container-2">
                    <img
                      className="image-align"
